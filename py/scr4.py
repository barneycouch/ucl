...
for i in chunklist3:
	print i
	abbacnt2 = Counter('ABBA')
	babacnt2 = Counter('BABA')
	abbbcnt2 = Counter('ABBB')
	babbbcnt2 = Counter('BABB')
	othercnt2 = Counter('other')
	no_datacnt2 = Counter('no_data')
	abbalist2.append(abbacnt2)
	babalist2.append(babacnt2)
	abbblist2.append(abbbcnt2)
	babbblist2.append(babbbcnt2)
	otherlist2.append(othercnt2)
	no_datalist2.append(no_datacnt2)
	
	
	
#print 'In the chunks, ABBA - %g, BABA - %g, ABBB - %g, BABB - %g, Other - %g, No Data - %g' % (abbacnt2, babacnt2, abbbcnt2, babbbcnt2, othercnt2, no_datacnt2)
